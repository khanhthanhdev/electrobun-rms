...
- Method: `GET`
- Path: `/api/sync/v1/admin/seasons/:season/events/:eventCode/clients`
...
- Method: `GET`
- Path: `/api/sync/v1/admin/seasons/:season/events/:eventCode/policy`
...
- Method: `GET`
- Path: `/api/sync/v1/admin/seasons/:season/events/:eventCode/batches`
